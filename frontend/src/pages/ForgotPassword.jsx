        ...
        <div className="border border-primary/25 flex flex-col lg:flex-row 
          ...
          <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
            <div className="max-w-md p-8 text-center">
              <h2 className="text-xl font-semibold">Recover Your Account</h2>
              <p className="opacity-70 mt-2">
                We'll send a secure link to reset your password and get you back to learning languages quickly.
              </p>
            </div>
          </div>
        </div>
